                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btnubah btn btn-sm btn-warning" idubah="<?php echo $r['id_crips']?>"><i class="material-icons">mode_edit</i> Ubah</button>
                                            <button type="button" class="btnhapus btn btn-sm btn-danger" idhapus="<?php echo $r['id_crips']?>"><i class="material-icons">delete</i> Hapus</button>
                                        </td>
                                    </tr>
                                <?php $no++; endwhile;?>
                            </tbody>
